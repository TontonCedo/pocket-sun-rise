...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ArticleID: Schema.Attribute.UID<'ArticleName'> & Schema.Attribute.Required;
    ArticleMedia: Schema.Attribute.Media<'images' | 'files', true>;
    ArticleName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    ArticleText: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sub_region: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiRegionRegion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    RegionArea: Schema.Attribute.Enumeration<
      [
        'Hokkaido',
        'Tohoku',
        'Kanto',
    ...
    RegionSubName: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Visible: Schema.Attribute.Boolean &
...
export interface ApiSubRegionSubRegion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    subGuideJPName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    subRegionDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    SubRegionID: Schema.Attribute.UID<'SubRegionName'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 5;
      }>;
    SubRegionImage: Schema.Attribute.Media<'images'>;
    SubRegionName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
